<%@ Page Language="C#" AutoEventWireup="true" CodeFile="09.aspx.cs" Inherits="Book_Sample_Ch03_WebControls_9" %>
...
<body>
    ...
    <div>
        ...
        <br />
        您剛剛選擇的文章（ID編號）：<asp:Label ID="Label2" runat="server" ForeColor="#009900"></asp:Label>
    </div>
    </form>
</body>
</html>

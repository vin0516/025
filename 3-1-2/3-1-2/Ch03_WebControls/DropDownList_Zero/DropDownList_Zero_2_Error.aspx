<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DropDownList_Zero_2_Error.aspx.cs" Inherits="Book_Sample_Ch03_WebControls_DropDownList_Zero_DropDownList_Zero_1" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <span class="auto-style1"><strong>啟動 AppendDataBoundItem = true</strong></span><br />
        <br />
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" 
            DataTextField="city_name" DataValueField="a1_id" AppendDataBoundItems="True">
        ...
        <p>
            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2" 
                DataTextField="district_name" DataValueField="a2_id"  AppendDataBoundItems="True">
                <asp:ListItem>==請選擇==</asp:ListItem>
            </asp:DropDownList>

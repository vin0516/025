...
public partial class Book_Sample_Ch03_WebControls_9_Calendar : System.Web.UI.Page
{
    ...
    protected void Calendar1_SelectionChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Calendar1.SelectedDates.Count >= 1)
            {
                ...
                // 改成 .ToLongDateString()會變成「年月日」。
                // 參考資料：  http://blog.xuite.net/chu.hsing/Think/27833158
            }
            else
            {

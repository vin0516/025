<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="TextBox_Click.aspx.cs" Inherits="Book_Sample_Ch03_WebControls_TextBox_Click" %>
...
<body>
    ...
    <asp:Button ID="Button1" runat="server" Visible="false" Text="Button_隱藏，看不見 (.Visible=false)" OnClick="Button1_Click" />
    <br />
    <br />
    <br />
    <br />

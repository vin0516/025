<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Calendar_Birthday_LeapYear0_Easy.aspx.cs" Inherits="Book_Sample_Ch03_WebControls_Calendar_Birthday_LeapYear" %>
...
<body>
    ...
    <div>
        ...
        每個月份有幾天？？&nbsp; DateTime的<strong><span class="auto-style1"> .DaysInMonth()方法</span></strong><br />
        <a href="http://msdn.microsoft.com/zh-tw/library/system.datetime.daysinmonth(v=vs.110).aspx">http://msdn.microsoft.com/zh-tw/library/system.datetime.daysinmonth(v=vs.110).aspx</a>
        <br />
        <br />
        <br />
        <br />
